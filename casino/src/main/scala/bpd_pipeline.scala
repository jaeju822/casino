...
class BranchPrediction(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class BranchPredictionStage(fetch_width: Int)(implicit p: Parameters) extends CasinoModule()(p)
