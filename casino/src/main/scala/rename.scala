...
class RenameMapTableElementIo(pl_width: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class RenameMapTableElement(pipeline_width: Int)(implicit p: Parameters) extends CasinoModule()(p)
{
...
class FreeListIo(num_phys_registers: Int, pl_width: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class RenameFreeList(num_phys_registers: Int // number of physical registers
                    , pl_width: Int          // pipeline width ("dispatch group size")
                     )(implicit p: Parameters) extends CasinoModule()(p)
{
...
class BusyTableIo(pipeline_width:Int, num_read_ports:Int, num_wb_ports:Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
...
// critical path).
class BusyTable(pipeline_width:Int, num_read_ports:Int, num_wb_ports:Int)(implicit p: Parameters) extends CasinoModule()(p)
{
...
class RenameStageIO(pl_width: Int, num_wb_ports: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class DebugRenameStageIO(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class RenameStage(pl_width: Int, num_wb_ports: Int)(implicit p: Parameters) extends CasinoModule()(p)
{
