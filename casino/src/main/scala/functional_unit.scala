...
class FuncUnitReq(data_width: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
   val uop = new MicroOp()
...
class FuncUnitResp(data_width: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
   val uop = new MicroOp()
...
class BypassData(num_bypass_ports: Int, data_width: Int)(implicit p: Parameters) extends CasinoBundle()(p)
{
...
class BrResolutionInfo(implicit p: Parameters) extends CasinoBundle()(p)
{
   val valid      = Bool()
   val mispredict = Bool()
...
class BranchUnitResp(implicit p: Parameters) extends CasinoBundle()(p)
{
   val take_pc         = Bool()
